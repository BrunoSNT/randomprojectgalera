...
class AdventuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adventure" do
    assert_difference('Adventure.count') do
      post adventures_url, params: { adventure: { description: @adventure.description, name: @adventure.name, theme: @adventure.theme } }
    end
  ...
  test "should update adventure" do
    patch adventure_url(@adventure), params: { adventure: { description: @adventure.description, name: @adventure.name, theme: @adventure.theme } }
