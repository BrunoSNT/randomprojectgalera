...
class AlignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alignment" do
    assert_difference('Alignment.count') do
      post alignments_url, params: { alignment: { description: @alignment.description, name: @alignment.name } }
    end
  ...
  test "should update alignment" do
    patch alignment_url(@alignment), params: { alignment: { description: @alignment.description, name: @alignment.name } }
